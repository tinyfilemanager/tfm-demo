...
$CONFIG = '{"lang":"ro","error_reporting":false,"show_hidden":false,"hide_Cols":true,"theme":"light"}';
...
//Application Title
define('APP_TITLE', 'Tiny File Manager | Demo');
...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/api';
...
$max_upload_size_bytes = 0; // size 5,000,000,000 bytes (~5GB)
...
$hide_Cols = isset($_COOKIE['hide_Cols']) ? $_COOKIE['hide_Cols'] : false;
...
if (isset($_POST['ajax'], $_POST['token']) && !FM_READONLY) {
    ...
    if(isset($_POST['type']) && $_POST['type']=="search") {
        echo json_encode(array("name"=>"Demo", "type" => "file", "path" =>""));
        exit();
    }
    ...
    if (isset($_POST['type']) && $_POST['type'] == "settings") {
        ...
        $shf = isset($_POST['js-show-hidden']) && $_POST['js-show-hidden'] == false;
        $hco = isset($_POST['js-hide-cols']) && $_POST['js-hide-cols'] == "true" ? true : false;
        $te3 = $_POST['js-theme-3'];

        setcookie('lang', $newLng, time() + (10000 * 30), "/");
        setcookie('hide_Cols', $hco, time() + (10000 * 30), "/");
        setcookie('theme', $te3, time() + (10000 * 30), "/");
    ...
    if(isset($_POST['type']) && $_POST['type'] == "upload" && !empty($_REQUEST["uploadurl"])) {
        echo json_encode(array("message" => "Demo version not supported"));
        exit();
    }
    exit();
}
...
if (isset($_GET['del'], $_POST['token']) && !FM_READONLY) {
    fm_set_msg(lng('Demo version not supported'), 'error');
}
...
if (!empty($_FILES) && !FM_READONLY) {
    $response = array ('status' => 'error','info' => "Demo version not supported");
            ...
            <div class="card-body">
                <form id="js-settings-form" action="" method="post" data-type="ajax" onsubmit="return save_settings(this)">
                    ...
                    <div class="mt-3 mb-3 row ">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-switch">
                              <input class="form-check-input" type="checkbox" role="switch" id="js-error-report" disabled name="js-error-report" value="true" <?php echo $report_errors ? 'checked' : ''; ?> />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-switch">
                              <input class="form-check-input" type="checkbox" role="switch" id="js-show-hidden" disabled name="js-show-hidden" value="true" <?php echo $show_hidden_files ? 'checked' : ''; ?> />
                            </div>
                        </div>
                    </div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-6HZHHKJX49"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-6HZHHKJX49');
</script>
<?php if (FM_USE_HIGHLIGHTJS && isset($_GET['view'])): ?>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Tiny File Manager';      $tr['en']['AppTitle']           = 'H3K Demo';
